...
const Home = (props) => {
	const pages = [
		...
		// { href: "/dragons", icon: "🐉", text: "Dragons" },
	];
	...
	return (
		<Layout noTitle full>
			<motion.div
				...
				<motion.div className='flex flex-col text-sm text-center text-gray-400' variants={fade}>
					<span>Created with ♥</span>
					<a href="https://github.com/Syakhisk" target="_blank" className="hover:text-red-500">&copy; Syakhisk Al-Azmi - 2021</a>
					<a href="https://github.com/Syakhisk/spacex-data-showcase" target="_blank" className='flex items-center justify-center h-5 space-x-2 hover:text-red-500'>
